 ...
 *
 * Each role can also expose `specialties` — sub-categories (style, genre,
 * medium) that an artist picks AFTER choosing their role. This replaces the
 * old free-form "Mediums" field.
 */
