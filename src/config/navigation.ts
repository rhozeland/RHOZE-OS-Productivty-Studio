...
export const EXTRA_ALIASES: NavAlias[] = [
  // Smartboards / Drop Rooms index routes are absorbed by Projects.
  // Detail routes (/smartboards/:id, /drop-rooms/:id) remain mounted in
  // App.tsx for direct access from the project Tools panel.
  //
  // /flow is intentionally NOT aliased — Flow Mode is a first-class page
  // again as the public browser for fingerprinted creative IP. The Tools
  // tab inside Projects still links to it via a real route.
];
