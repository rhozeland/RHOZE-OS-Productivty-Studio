...
const PAGES: { name: string; path: string; icon: any; keywords?: string[] }[] = [
  ...
  { name: "Marketplace", path: "/marketplace", icon: ShoppingBag, keywords: ["offerings", "services", "shop", "listings"] },
  { name: "Events", path: "/marketplace?kind=event", icon: Calendar, keywords: ["shows", "tickets", "calendar"] },
  { name: "Spaces", path: "/marketplace?kind=space", icon: Building2, keywords: ["studios", "venues", "rooms"] },
