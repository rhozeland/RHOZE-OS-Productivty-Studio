/**
 * ListingsTab — the user's own marketplace listings, surfaced inside
 * Conversations so posting/managing offerings sits next to the inquiries
 * that result from them.
 *
 * Lightweight: lists my listings with quick actions (view, deactivate)
 * + a "Post a listing" CTA that opens the existing CreateListingDialog.
 * Browsing other people's listings still happens on Discover (Offerings
 * filter) and individual listing detail pages.
 */
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-3">
        <p className="text-sm text-muted-foreground">
          Your offerings, products and open calls. Inquiries land in the Inquiries tab.
        </p>
