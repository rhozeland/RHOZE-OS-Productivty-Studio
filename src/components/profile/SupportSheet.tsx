          ...
          <Tabs value={tab} onValueChange={(v) => setTab(v as SupportTab)} className="flex-1 flex flex-col min-h-0">
            ...
            <div className="flex-1 overflow-y-auto px-4 pb-5 pt-3">
              ...
              <TabsContent value="work" className="mt-0 space-y-2.5">
                {/* Start a project — leads straight into the roadmap workspace */}
                <button
                  type="button"
                  onClick={handleCommission}
                  className="w-full text-left rounded-xl border border-foreground/20 bg-gradient-to-br from-foreground/5 to-primary/5 hover:border-foreground/40 p-5 transition-all"
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground mt-1.5 leading-relaxed">
                        Spin up a shared workspace with {creatorName}. Build the roadmap together, send it for approval, then lock scope, milestones, and escrow.
                      </p>
                    </div>
                  </div>
                </button>
